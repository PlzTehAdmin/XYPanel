...
local ti = function(length) 
	return TweenInfo.new(length or 0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out)--REAL SOURCE OMG PLZ GIVE AM BEG
...
togglefalse = nil
toggletrue = nil--REAL SOURCE OMG PLZ GIVE AM BEG
--REAL SOURCE OMG PLZ GIVE AM BEG
...
library.descriptiontext = Color3.fromRGB(170, 170, 170)--REAL SOURCE OMG PLZ GIVE AM BEG
...
function library:Create(name, size)
	...
	UILIB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	shadow.BackgroundTransparency = 1--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	if s then
		...
		event:connect(function()--REAL SOURCE OMG PLZ GIVE AM BEG
    ...
    --REAL SOURCE OMG PLZ GIVE AM BEG--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	CloseUI.Size = UDim2.new(0, 25, 0, 25)--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	CloseUI.MouseLeave:connect(function()--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	TextLabel.Size = UDim2.new(1, 0, 1, 0)--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	Search.BackgroundColor3 = library.searchbar--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	local Container = Instance.new("ScrollingFrame")--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	Container.ScrollingDirection = Enum.ScrollingDirection.Y--REAL SOURCE OMG PLZ GIVE AM BEG

    --REAL SOURCE OMG PLZ GIVE AM BEG
	Container.ScrollBarImageColor3 = library.scrollbar
	Container.BorderSizePixel = 0
	Container.TopImage = "rbxassetid://967852042"
	Container.MidImage = "rbxassetid://967852042"--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	Search.Changed:connect(function(text)
		updatescroll()
		local text = Search.Text:lower()--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		if text ~= "" then
			...
			for _, button in next, Container:GetChildren() do
				if button:IsA("TextButton") then
					button.Visible = true--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	function features:Divider(name)--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Divider.Font = Enum.Font.SourceSansSemibold--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	function features:Button(name, description, callback)
		name = name or "Button"
		description = description or "Button's description"--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		ButtonContainer.BackgroundColor3 = library.buttoncontainer--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Buttonname.Text = name--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		local Buttondescription = Instance.new("TextLabel")--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Buttondescription.TextXAlignment = Enum.TextXAlignment.Left--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Button.Position = UDim2.new(1, -5, 0, 5)--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	function features:Toggle(name, description, state, callback)--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		ToggleContainer.Name = "Toggle"--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		ToggleContainer.AutoButtonColor = false--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		local ButtonName = Instance.new("TextLabel")
		ButtonName.Name = "ButtonName"--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		ButtonName.Position = UDim2.new(0, 10, 0, 0)
		ButtonName.Size = UDim2.new(0.5, 0, 0.5, 0)
		ButtonName.Font = Enum.Font.SourceSansSemibold--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Description.Parent = ToggleContainer--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Colour.Name = "Colour"--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Sliding.Size = UDim2.new(0.5, 0, 1, 0)--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		local hovered = ts:Create(ToggleContainer, ti(0.2), {BackgroundColor3 = library.buttoncontainerhovered})--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		ToggleContainer.MouseButton1Click:connect(function()
			...
			if state then--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	function features:Dropdown(name, description, options, callback)
		...
		Dropdown.AutoButtonColor = --REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		local ButtonName = Instance.new("TextLabel")--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Description.AnchorPoint = Vector2.new(0, 1)--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Description.TextColor3 = library.descriptiontext
		Description.TextSize = 15
		Description.TextXAlignment = Enum.TextXAlignment.Left--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		ImageLabel.Size = UDim2.new(1, 0, 1, 0)--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		DropdownListLayout.Parent = OptionsContainer--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		for i, v in next, options do
			...
			if i ~= 1 then--REAL SOURCE OMG PLZ GIVE AM BEG
				...
				Dropdown.MouseLeave:connect(function()--REAL SOURCE OMG PLZ GIVE AM BEG
			...
			TextLabel.Size = UDim2.new(1, -12, 1, 0)--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Dropdown.MouseEnter:connect(function()--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Dropdown.MouseButton1Click:connect(function()--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
	...
	function features:Slider(name, description, min, max, default, callback)
		...
		Slider.Text = ""--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		ButtonName.BackgroundTransparency = 1
		ButtonName.Position = UDim2.new(0, 10, 0, 0)
		ButtonName.Size = UDim2.new(0.5, 0, 0.5, 0)--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Description.AnchorPoint = Vector2.new(0, 1)
		Description.BackgroundColor3 = Color3.new(1, 1, 1)
		Description.BackgroundTransparency = 1--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		slidinground.CornerRadius = UDim.new(0, 2)--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Indicator.Position = UDim2.new(0.5, 0, 0.5, 0)--REAL SOURCE OMG PLZ GIVE AM BEG
		...
		Value.Font = Enum.Font.SourceSansSemibold--REAL SOURCE OMG PLZ GIVE AM BEG
...
--REAL SOURCE OMG PLZ GIVE AM BEG
		connection = is.InputEnded:connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseButton1 and UILIB then
				down = false
				Indicator:TweenPosition(UDim2.new(percentage, 0, 0.5, 0), Enum.EasingDirection.InOut, Enum.--REAL SOURCE OMG PLZ GIVE AM BEG

                --REAL SOURCE OMG PLZ GIVE AM BEGEasingStyle.Linear, 0.02) 
...
return library--REAL SOURCE OMG PLZ GIVE AM BEG
